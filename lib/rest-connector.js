 ...
 * @param {function} [callback] The callback function
 */
RestConnector.prototype.find = function find(model, filter, options, callback) {
  this.getResource(model).find(filter, options, this.responseHandler(model, callback));
};
